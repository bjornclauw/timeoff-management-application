...
module.exports = function(sequelize, DataTypes){
  ...
  var Schedule = sequelize.define("Schedule", {
    maandag : {
      ...
      set          : week_day_flag_setter('maandag'),
    },
    dinsdag : {
      type         : DataTypes.INTEGER,
      allowNull    : false,
      defaultValue : works_whole_day(),
      set          : week_day_flag_setter('dinsdag'),
    },
    woensdag : {
      type         : DataTypes.INTEGER,
      allowNull    : false,
      defaultValue : works_whole_day(),
      set          : week_day_flag_setter('woensdag'),
    },
    donderdag : {
      type         : DataTypes.INTEGER,
      allowNull    : false,
      defaultValue : works_whole_day(),
      set          : week_day_flag_setter('donderdag'),
    },
    vrijdag : {
      type         : DataTypes.INTEGER,
      allowNull    : false,
      defaultValue : works_whole_day(),
      set          : week_day_flag_setter('vrijdag'),
    },
    zaterdag : {
      type         : DataTypes.INTEGER,
      allowNull    : false,
      defaultValue : works_none(),
      set          : week_day_flag_setter('zaterdag'),
    },
    zondag : {
      type         : DataTypes.INTEGER,
      allowNull    : false,
      defaultValue : works_none(),
      set          : week_day_flag_setter('zondag'),
    },
  },{
    ...
    instanceMethods : {
      ...
      works_monday : function(){
        return this.maandag === works_whole_day();
      },

      works_tuesday : function(){
        return this.dinsdag === works_whole_day();
      },

      works_wednesday : function(){
        return this.woensdag === works_whole_day();
      },

      works_thursday : function(){
        return this.donderdag === works_whole_day();
      },

      works_friday : function(){
        return this.vrijdag === works_whole_day();
      },

      works_saturday : function(){
        return this.zaterdag === works_whole_day();
      },

      works_sunday : function(){
        return this.zondag === works_whole_day();
      },
