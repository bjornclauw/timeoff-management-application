...
const leaveIntoObject = (leave) => {
  ...
  const statusMap = {
    [Leave.status_new()]:           'Nieuw',
    [Leave.status_approved()]:      'Goedgekeurd',
    [Leave.status_rejected()]:      'Afgewezen',
    [Leave.status_pended_revoke()]: 'Wachten op intrekken',
    [Leave.status_canceled()]:      'Geannuleerd',
  };
